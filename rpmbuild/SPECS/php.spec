...
# Add conflicts for non-8.2 PHP namespaced packages
Conflicts: php < %{phpver}.0
Conflicts: php > %{phpver}.99

# To avoid dependency conflict issues (now that we are requiring an
# external php module), we also require the xml and process modules
...
%description
PHP %{phpver} is an HTML-embedded scripting language. PHP %{phpver} attempts to make it
easy for developers to write dynamically generated web pages. PHP %{phpver} also
offers built-in database integration for several commercial and
non-commercial database management systems, so writing a
database-enabled webpage with PHP %{phpver} is fairly simple. The most common
use of PHP %{phpver} coding is probably as a replacement for CGI scripts.
%if %{with modphp}
The php package contains the module (often referred to as mod_php)
which adds support for the PHP %{phpver} language to Apache HTTP Server when
running in prefork mode. This module is deprecated.
%endif

%package cli
Summary: Command-line interface for PHP %{phpver}
# sapi/cli/ps_title.c is PostgreSQL
License: PHP and Zend and BSD and MIT and ASL 1.0 and NCSA and PostgreSQL
# Add conflicts for non-8.2 PHP namespaced packages
Conflicts: php-cli < %{phpver}.0
Conflicts: php-cli > %{phpver}.99
...
executing PHP %{phpver} scripts, /usr/bin/php, and the CGI interface.


%package dbg
Summary: The interactive PHP %{phpver} debugger
Provides: php-dbg = %{version}-%{release}
Provides: php-dbg%{?_isa} = %{version}-%{release}
Requires: php-common%{?_isa} = %{version}-%{release}

%description dbg
The %{phpname}-dbg package contains the interactive PHP %{phpver} debugger.


%package fpm
Summary: PHP %{phpver} FastCGI Process Manager
...
%description fpm
PHP-FPM (FastCGI Process Manager) is an alternative PHP %{phpver} FastCGI
implementation with some additional features useful for sites of
any size, especially busier sites.

%package common
Summary: Common files for PHP %{phpver}
# All files licensed under PHP version 3.01, except
# fileinfo is licensed under PHP version 3.0
# regex, libmagic are licensed under BSD
License: PHP and BSD
# Add conflicts for non-8.2 PHP namespaced packages
Conflicts: php-common < %{phpver}.0
Conflicts: php-common > %{phpver}.99
...
%package devel
Summary: Files needed for building PHP %{phpver} extensions
...
extensions. If you need to compile your own PHP %{phpver} extensions, you will
...
%description opcache
The Zend OPcache provides faster PHP %{phpver} execution through opcode caching and
optimization. It improves PHP %{phpver} performance by storing precompiled script
...
%description imap
The %{phpname}-imap module will add IMAP (Internet Message Access Protocol)
support to PHP %{phpver}. IMAP is a protocol for retrieving and uploading e-mail
messages on mail servers. PHP %{phpver} is an HTML-embedded scripting language.
%endif

%package ldap
Summary: A module for PHP %{phpver} applications that use LDAP
# All files licensed under PHP version 3.01
License: PHP
...
%description ldap
The %{phpname}-ldap adds Lightweight Directory Access Protocol (LDAP)
support to PHP %{phpver}. LDAP is a set of protocols for accessing directory
services over the Internet. PHP %{phpver} is an HTML-embedded scripting
language.

%package pdo
Summary: A database access abstraction module for PHP %{phpver} applications
# All files licensed under PHP version 3.01
License: PHP
...
a database access abstraction layer to PHP %{phpver}.  This module provides
a common interface for accessing MySQL, PostgreSQL or other
databases.

%package mysqlnd
Summary: A module for PHP %{phpver} applications that use MySQL databases
# All files licensed under PHP version 3.01
License: PHP
...
MySQL database support to PHP %{phpver}. MySQL is an object-relational database
management system. PHP %{phpver} is an HTML-embeddable scripting language. If
you need MySQL support for PHP %{phpver} applications, you will need to install
this package and the php package.

This package use the MySQL Native Driver

%package pgsql
Summary: A PostgreSQL database module for PHP %{phpver}
# All files licensed under PHP version 3.01
License: PHP
...
%description pgsql
The %{phpname}-pgsql package add PostgreSQL database support to PHP %{phpver}.
PostgreSQL is an object-relational database management
system that supports almost all SQL constructs. PHP %{phpver} is an
HTML-embedded scripting language. If you need back-end support for
PostgreSQL, you should install this package in addition to the main
php package.

%package process
Summary: Modules for PHP %{phpver} script using system process interfaces
# All files licensed under PHP version 3.01
License: PHP
# Add conflicts for non-8.2 PHP namespaced packages
Conflicts: php-process < %{phpver}.0
Conflicts: php-process > %{phpver}.99
...
support to PHP %{phpver} using system interfaces for inter-process
communication.

%package odbc
Summary: A module for PHP %{phpver} applications that use ODBC databases
# All files licensed under PHP version 3.01, except
...
database support through ODBC to PHP %{phpver}. ODBC is an open specification
which provides a consistent API for developers to use for accessing
data sources (which are often, but not always, databases). PHP is an
HTML-embeddable scripting language. If you need ODBC support for PHP %{phpver}
applications, you will need to install this package and the php
package.

%package soap
Summary: A module for PHP %{phpver} applications that use the SOAP protocol
# All files licensed under PHP version 3.01
License: PHP
...
support to PHP %{phpver} for using the SOAP web services protocol.
...
The %{phpname}-pdo-firebird package contains the PDO driver for
Interbase/Firebird databases.
%endif

%if %{with snmp}
%package snmp
Summary: A module for PHP %{phpver} applications that query SNMP-managed devices
# All files licensed under PHP version 3.01
License: PHP
...
support for querying SNMP devices to PHP %{phpver}.  PHP %{phpver} is an HTML-embeddable
scripting language. If you need SNMP support for PHP applications, you
will need to install this package and the php package.
%endif

%package xml
Summary: A module for PHP %{phpver} applications which use XML
# All files licensed under PHP version 3.01
License: PHP
# Add conflicts for non-8.2 PHP namespaced packages
Conflicts: php-xml < %{phpver}.0
Conflicts: php-xml > %{phpver}.99
...
to PHP %{phpver} for manipulating XML documents using the DOM tree,
and performing XSL transformations on XML documents.

%package mbstring
Summary: A module for PHP %{phpver} applications which need multi-byte string handling
# All files licensed under PHP version 3.01, except
...
support for multi-byte string handling to PHP %{phpver}.

%package gd
Summary: A module for PHP %{phpver} applications for using the gd graphics library
# All files licensed under PHP version 3.01
License: PHP
...
support for using the gd graphics library to PHP %{phpver}.

%package bcmath
Summary: A module for PHP %{phpver} applications for using the bcmath library
# All files licensed under PHP version 3.01, except
...
support for using the bcmath library to PHP %{phpver}.

%package gmp
Summary: A module for PHP %{phpver} applications for using the GNU MP library
# All files licensed under PHP version 3.01
License: PHP
...
%package dba
Summary: A database abstraction layer module for PHP %{phpver} applications
# All files licensed under PHP version 3.01
License: PHP
%if %{with db4}
...
support for using the DBA database abstraction layer to PHP %{phpver}.

%if %{with tidy}
%package tidy
Summary: Standard PHP %{phpver} module provides tidy library support
# All files licensed under PHP version 3.01
License: PHP
...
support for using the tidy library to PHP %{phpver}.
%endif
...
The %{phpname}-pdo-dblib package contains a dynamic shared object
that implements the PHP Data Objects (PDO) interface to enable access from
PHP %{phpver} to Microsoft SQL Server and Sybase databases through the FreeTDS library.
%endif

%package embedded
Summary: PHP %{phpver} library for embedding in applications
...
into applications to provide PHP %{phpver} scripting language support.

%if %{with pspell}
%package pspell
Summary: A module for PHP %{phpver} applications for using pspell interfaces
# All files licensed under PHP version 3.01
License: PHP
...
support for using the pspell library to PHP %{phpver}.
%endif

%package intl
Summary: Internationalization extension for PHP %{phpver} applications
# All files licensed under PHP version 3.01
License: PHP
...
support for using the ICU library to PHP %{phpver}.

%package enchant
Summary: Enchant spelling extension for PHP %{phpver} applications
...
%description enchant
The %{phpname}-enchant package contains a dynamic shared object that will add
support for using the enchant library to PHP %{phpver}.
...
%description sodium
The %{phpname}-sodium package provides a simple,
low-level PHP %{phpver} extension for the libsodium cryptographic library.
%endif

%if %{with zip}
%package zip
Summary: ZIP archive management extension
# All files licensed under PHP version 3.0.1
License: PHP
Provides: php-zip = %{version}-%{release}
Provides: php-zip%{?_isa} = %{version}-%{release}
BuildRequires:  pkgconfig(libzip) >= 0.11

Requires: php-common%{?_isa} = %{version}-%{release}
Provides:  php-pecl(zip)         = %{version}
Provides:  php-pecl(zip)%{?_isa} = %{version}

%description zip
The %{phpname}-zip package provides an extension to create and read zip files.
%endif
...
For PHP %{phpver}, FFI opens a way to write PHP %{phpver} extensions and bindings to C libraries
in pure PHP %{phpver}.
...
# Install extension modules in %%{_libdir}/%%{phpname}/modules.
...
TESTCMD="$TESTCMD --define extension_dir=$RPM_BUILD_ROOT%{_libdir}/%{phpname}/modules"
...
%endif
    ...
    cat > files.${mod} <<EOF
%{_libdir}/%{phpname}/modules/${mod}.so
...
* Wed Feb 07 2024 Stewart Smith <trawets@amazon.com> - 8.2.15-1.amzn2023.0.2
- Rebuild for libsodium 1.0.19

* Sat Jan 20 2024 Stewart Smith <trawets@amazon.com> - 8.2.15-1.amzn2023.0.1
- Package updated to 8.2.15

* Fri Sep 8 2023 Benjamin Herrenschmidt <benh@amazon.com> - 8.2.9-1.amzn2023.0.3
- Add php-zip extension
- Add php-sodium extension

* Wed Aug 30 2023 Sonia Xu <sonix@amazon.com> - 8.2.9-1.amzn2023.0.2
- Rebuild for new gcc

* Wed Aug 23 2023 Bharat Kulkarni <bkkulkar@amazon.com> - 8.2.9-1.amzn2023.0.1
- Package updated to 8.2.9

* Tue Aug 15 2023 David Omofonma <daomofon@amazon.com> - 8.2.8-1.amzn2023.0.1
- Package updated to 8.2.8

* Mon Jun 19 2023 Sonia Xu <sonix@amazon.com> - 8.2.7-1.amzn2023.0.1
- Package updated to 8.2.7

* Wed Jun 07 2023 Sonia Xu <sonix@amazon.com> - 8.2.4-1.amzn2023.0.1
- Namespaced extension library directories
- Enabled pspell and snmp

* Thu Apr 06 2023 Aishwarya Vivek Bhavsar <aishvbha@amazon.com> - 8.2.4-1.amzn2023.0.1
- Package updated to 8.2.4

* Thu Apr 06 2023 Aishwarya Vivek Bhavsar <aishvbha@amazon.com> - 8.1.17-1.amzn2023.0.1
- Package updated to 8.1.17

* Tue Mar 14 2023 Sonia Xu <sonix@amazon.com> - 8.1.16-1.amzn2023.0.1
- Package updated to 8.1.16

* Wed Feb 01 2023 Stewart Smith <trawets@amazon.com> - 8.1.14-1.amzn2023.0.2
- Mass rebuild for AL2023

* Fri Jan 20 2023 Trinity Quirk <tquirk@amazon.com> - 8.1.14-1.amzn2023.0.1
- Package updated to 8.1.14

* Thu Jan 05 2023 Vighnesh Maheshwari <vighmah@amazon.com> - 8.1.12-1.amzn2022.0.2
- Rebuild with latest libpq release

* Mon Nov 07 2022 Jeremiah Mahler <jmmahler@amazon.com> - 8.1.12-1.amzn2022.0.1
- Upgraded to 8.1.12

* Mon Oct 10 2022 Sonia Xu <sonix@amazon.com> 8.1.7-1.amzn2022.0.4
- Change expose_php to off

* Tue Oct 04 2022 Stewart Smith <trawets@amazon.com> - 8.1.7-1.amzn2022.0.3
- AL2022 pre-GA mass rebuild

* Tue Jul 19 2022 Sai Harsha <ssuryad@amazon.com> - php8.1-8.1.7-1.amzn2022.0.1
- Namespace php to php8.1

* Fri Jun 17 2022 Stewart Smith <trawets@amazon.com> - 8.1.7-1.amzn2022.0.5
- Build without SNMP on Amazon Linux
...
* Tue May 24 2022 Benjamin Herrenschmidt <benh@amazon.com> 7.4.28-1.amzn2022.0.4
- Disable libsodium

* Thu May 19 2022 Trinity Quirk <tquirk@amazon.com> 7.4.28-1.amzn2022.0.3
- Update to 7.4.28-1

* Sat May 14 2022 Stewart Smith <trawets@amazon.com> - 7.4.27-1.amzn2022.0.3
- Actually build AL config, not Fedora
...
* Fri Jan 28 2022 Paul Ezvan <paulezva@amazon.fr> - 7.4.27-1.amzn2022.0.2
- Update to 7.4.27-1
...
* Thu Oct 14 2021 Stewart Smith <trawets@amazon.com> - 7.4.19-1.amzn2022.0.1
- Set default build options for Amazon Linux
